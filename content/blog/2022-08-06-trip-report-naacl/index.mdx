...
Different aspects and design choices in text-editing models were discussed. For example:
 ...
 text editing models like Levensthein Transformer, LEWIS,
 [FELIX](https://aclanthology.org/2020.findings-emnlp.111/) and LaserTagger
 ...
 requiring a very large phrasebook to get good performance. On the other hand, GeCTOR
 and PIE have a large number of available edit operations, which when chosen, admit
...
taken for each.
 ...
 Once you have a structure, you will want to do infernece over that structure in a 
...
[Systematicity Emerges in Transfromers when Abstract Grammatical Roles Guide Attention](https://aclanthology.org/2022.naacl-srw.1/) in the poster session,
